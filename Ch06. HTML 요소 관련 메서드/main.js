...
- attr()메서드는 html의 입장에서, prop() 메서드는 javascript의 입장에서 가져온다.
*/
...
$(document).ready(function () {
    ...
    //매개변수가 한개인 경우(세터)
    $(".text3").text("<a href='#'>링그태그</a>");
    $(".text4").html("<a href='#'>링그태그</a>");
    ...
    //매개변수가 객체인 경우(세터)
    //prop을 사용해도 되지만 보통 attr메서드를 더 많이 사용한다.
    //   $("img").attr({
    //     width: 800,
    //     height: 500,
    //   });
